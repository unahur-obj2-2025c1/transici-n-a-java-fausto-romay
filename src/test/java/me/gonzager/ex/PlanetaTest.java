...
public class PlanetaTest {
    ...
    private Atleta rosa = new Atleta(45);
    private Atleta perla = new Atleta(28);
    private Docente monica = new Docente(45);
    private Docente luisa = new Docente(35);
    private Planeta triton = new Planeta(List.of(julieta, ana, rosa, perla, monica, luisa), 0, 0);
    ...
    public void delegacionDiplamaticaDeTriton(){
        assertEquals(List.of(ana, rosa, monica), triton.delegacionDiplomatica());
    }

    @Test
    public void valorInicialDeDefensaDeTriton(){
        assertEquals(2, triton.defensaInicial());
    }
    ...
    public void tritonNecesitaReforzarse(){    
        assertFalse(triton.necesitaRefuerzos());
    }
    ...
    public void apaciguarOtroPlanetaPaleas(){
        Planeta paleas = new Planeta(List.of(rosa, perla), 0, 0);
